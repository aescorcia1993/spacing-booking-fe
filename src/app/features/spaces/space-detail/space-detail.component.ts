...
@Component({
  ...
  template: `
    <div class="space-detail-container">
      ...
      @if (loading()) {
        <p-card>
          <p-skeleton width="100%" height="400px" styleClass="mb-4" />
          <p-skeleton width="60%" height="2rem" styleClass="mb-3" />
          <p-skeleton width="100%" height="6rem" styleClass="mb-3" />
                      ...
                      <div class="feature-item">
                        ...
                        <div>
                          ...
                          <span class="feature-value">
                            {{ space()!.available_hours['start'] }} - {{ space()!.available_hours['end'] }}
                          </span>
                        </div>
                      </div>
                    }
          ...
          <div class="sidebar">
            <p-card styleClass="booking-card">
              ...
              <p class="booking-info">
                Selecciona la fecha y hora para hacer tu reserva
              </p>
      ...
      @if (!loading() && !space()) {
        <p-card>
          <div class="not-found">
            ...
            <p>El espacio que buscas no existe o ha sido eliminado</p>
            <p-button
              label="Volver a espacios"
              icon="pi pi-arrow-left"
              routerLink="/spaces"
...
export class SpaceDetailComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (id) {
        // Limpiar el espacio anterior y cargar el nuevo
        console.log('📤 Clearing previous space and loading:', id);
